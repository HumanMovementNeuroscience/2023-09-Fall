# blender_1158765786161229856__from_summaries.md
...
- Creating a red-orange gradient on a sphere
- Creating a human figure shape in Blender
- Importing MakeHuman models into Blender
- Importance of Blender in the course
- Learning and using Blender effectively
- Blender's compatibility with Mac
- Time required to get used to using Blender
- Creating objects in Blender
- Adding color and shading to objects in Blender
- Adjusting camera view in Blender
- Troubleshooting rendering issues in Blender
- Creating motion paths in Blender
- Creating motion trails in Blender
- Illustrating the trace of an object in Blender
- Using the "Motion Paths" feature in Blender
- Finding the "Calculate Motion Paths" option in Blender
- Creating motion paths and motion trails in Blender
